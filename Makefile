...
$(KERNEL_MACHINE_PATH_OBJ)%_c.o: $(KERNEL_MACHINE_PATH_SRC)%.c Makefile
	@echo "[CC  ] $<"
	@$(CROSS_CC) $(CROSS_CCFLAGS) -I$(KERNEL_MACHINE_PATH_SRC) -MD -MP -DKERNEL_MACHINE=$(MACHINE) -DKERNEL_ARCH=$(ARCH) -c $< -o $@
$(KERNEL_MACHINE_PATH_OBJ)%_cpp.o: $(KERNEL_MACHINE_PATH_SRC)%.cpp Makefile
	@echo "[C++ ] $<"
	@$(CROSS_CXX) $(CROSS_CXXFLAGS) -I$(KERNEL_MACHINE_PATH_SRC) -MD -MP -DKERNEL_MACHINE=$(MACHINE) -DKERNEL_ARCH=$(ARCH) -c $< -o $@
# Kernel machine/arch
...
$(KERNEL_ARCH_PATH_OBJ)%_c.o: $(KERNEL_ARCH_PATH_SRC)%.c Makefile
	@echo "[CC  ] $<"
	@$(CROSS_CC) $(CROSS_CCFLAGS) -I$(KERNEL_ARCH_PATH_SRC) -MD -MP -DKERNEL_MACHINE=$(MACHINE) -DKERNEL_ARCH=$(ARCH) -c $< -o $@
$(KERNEL_ARCH_PATH_OBJ)%_cpp.o: $(KERNEL_ARCH_PATH_SRC)%.cpp Makefile
	@echo "[C++ ] $<"
	@$(CROSS_CXX) $(CROSS_CXXFLAGS) -I$(KERNEL_ARCH_PATH_SRC) -MD -MP -DKERNEL_MACHINE=$(MACHINE) -DKERNEL_ARCH=$(ARCH) -c $< -o $@
